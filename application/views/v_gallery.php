        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a href="<?= base_url('Gallery')?>" class="nav-link">Gallery</a></li>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="project">
                        ...
                        <a href="<?= base_url('assets/images/' . $i->galeri_gambar)?>"
                ...
                <div class="col-md-6">
                    <div class="ftco-footer-widget mb-4" style="margin-top: 40px">
                        <a class="navbar-brand" href="index.html">
                            <img src="assets/images/Palmy.png" width="50" /> &nbsp; By Mandiri Palmera
                            Agrindo
                        </a>
                    </div>
