...
<header class="main-header">
    ...
    <a href="#" class="logo">
        <span class="logo-mini">MPA</span>
        <span class="logo-lg" style="text-align: left;">Palmy</span>
    </a>
        ...
        <div class="navbar-custom-menu">
          ...
          ?>
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo base_url().'assets/images/'.$c['pengguna_photo'];?>" class="user-image"
                            alt="">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="<?php echo base_url().'assets/images/'.$c['pengguna_photo'];?>" class="img-circle"
                                alt="">
                ...
                <li>
                    ...
                    <a href="<?= base_url('Home'); ?>" target="_blank" title="Lihat Website"><i
