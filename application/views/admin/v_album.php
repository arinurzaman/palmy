...
<div class="wrapper">
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
                    ...
                    ?>
                <tr>
                  <td><img src="<?php echo base_url().'assets/images/album/' . $album_cover;?>" style="width:80px;"></td>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?= date('Y'); ?> <a href="#">PT. Mandiri Palmera Agrindo</a>.</strong> All rights reserved.
  </footer>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="xnama_album" class="col-sm-4 control-label">Nama Album</label>
                            <div class="col-sm-7">
                                <input type="text" name="xnama_album" class="form-control" id="xnama_album" placeholder="Nama Album" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="filefoto" class="col-sm-4 control-label">Cover Album</label>
                            <div class="col-sm-7">
